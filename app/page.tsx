...
import { company, engineeringServices, siteUrl } from '@/lib/config'
import { ArrowRight } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Engenharia Elétrica em Paulínia e Região',
...
export default function Home() {
  ...
  const structuredData = {
    ...
    name: company.name,
    url: siteUrl,
    logo: `${siteUrl}/novoLogo.png`,
    image: `${siteUrl}/og-image.jpg`,
    description: company.description,
    email: company.email,
    telephone: company.phone,
    areaServed: ['Paulínia', 'Campinas', 'Região Metropolitana de Campinas'],
    address: {
      '@type': 'PostalAddress',
    ...
    knowsAbout: engineeringServices.map((service) => service.title),
  }
